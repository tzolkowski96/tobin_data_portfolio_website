  ...
  return (
    <div className="max-w-4xl mx-auto container-responsive py-16 sm:py-24 page-transition">
      ...
      <section id="about" className="mb-24">
        ...
        <div className="space-y-10">
          ...
          <div className="vercel-card">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
            <h3 className="mb-8 text-2xl font-semibold">My Journey in Tech</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h3 className="mb-8 text-2xl font-semibold">Education</h3>
              <div className="space-y-8">
                <div className="border-l-2 border-gray-200 dark:border-gray-700 pl-6">
                  <div className="font-semibold text-lg">Master of Science, Information Science</div>
                  <div className="text-gray-600 dark:text-gray-400 mb-2">University of Wisconsin-Madison</div>
                  <div className="text-sm text-gray-500">Data Science, Machine Learning, Statistical Analysis</div>
                </div>
                <div className="border-l-2 border-gray-200 dark:border-gray-700 pl-6">
                  <div className="font-semibold text-lg">Bachelor of Arts, International Studies</div>
                  <div className="text-gray-600 dark:text-gray-400 mb-2">University of Wisconsin-Madison</div>
                  <div className="text-sm text-gray-500">Research Methods, Quantitative Analysis</div>
                </div>
                <div className="border-l-2 border-gray-200 dark:border-gray-700 pl-6">
                  <div className="font-semibold text-lg">Communication Science Studies</div>
                  <div className="text-gray-600 dark:text-gray-400 mb-2">Rochester Institute of Technology</div>
            ...
            <div>
              <h3 className="mb-8 text-2xl font-semibold">Certifications</h3>
              <ul className="space-y-4 text-gray-600 dark:text-gray-400">
                <li>
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="hover:text-black dark:hover:text-white transition-colors duration-200 link-underline"
                  >
      ...
      <section className="mb-32">
        <h2 className="mb-8">Available For</h2>
        <div className="section-divider"></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          {[
            ...
            <div key={item.title} className="minimal-card">
              <div className="flex items-center mb-4">
                <div className="mr-4 text-gray-600 dark:text-gray-400">{item.icon}</div>
