          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-600 dark:text-gray-400 text-small">Available via contact form</span>
              </div>
      ...
      <div className="pt-8 border-t border-gray-100 dark:border-gray-900">
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
          ...
          <div className="flex items-center space-x-4 text-small text-gray-500">
            ...
            >
              Medium <ExternalLink size={12} className="ml-1" />
            </a>
            <a 
              ...
              className="hover:opacity-70 flex items-center"
            >
              Newsletter <ExternalLink size={12} className="ml-1" />
            </a>
          </div>
        </div>
      </div>
