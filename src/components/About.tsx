...
const About = () => {
  return (
    <section id="about" className="py-16 md:py-24 bg-white dark:bg-gray-900 safe-area-inset block sm:block">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="md:col-span-1">
            <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-5 sm:p-6 h-full transform transition-transform hover:scale-105 shadow-md hover:shadow-xl">
              <div className="flex items-center mb-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-1 gap-2">
                ...
                <div className="bg-white dark:bg-gray-800 px-3 py-2 sm:px-4 rounded-lg shadow-sm text-gray-800 dark:text-white font-medium transform transition-transform hover:translate-x-2 text-sm sm:text-base col-span-2 sm:col-span-1">Administrative/Management Roles</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 md:mt-12 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-5 sm:p-6 shadow-md hover:shadow-xl transform transition-transform hover:scale-105">
            <div className="flex items-center mb-4">
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li className="bg-white dark:bg-gray-800 p-3 sm:p-4 rounded-lg shadow-sm">
                ...
                <div className="flex flex-wrap sm:flex-nowrap sm:items-center justify-between mt-2 gap-2">
                  ...
                  <a 
                    ...
                    className="text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 text-xs sm:text-sm flex items-center mobile-button min-h-[36px]"
                  >
          ...
          <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-5 sm:p-6 shadow-md hover:shadow-xl transform transition-transform hover:scale-105">
            <div className="flex items-center mb-4">
