      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            <h3 className="mb-2">Traffic Accident Analytics Engine</h3>
        ...
        <div className="mt-6 space-y-6 animate-fadeIn">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="minimal-card p-4 text-center">
                ...
                <p className="text-small text-gray-600 dark:text-gray-400">Total records</p>
              </div>
              <div className="minimal-card p-4 text-center">
                <div className="text-2xl font-semibold mb-1">49</div>
                <p className="text-small text-gray-600 dark:text-gray-400">US states</p>
              </div>
              <div className="minimal-card p-4 text-center">
                <div className="text-2xl font-semibold mb-1">47</div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="minimal-card p-4">
                <p className="font-medium mb-2">Statistical Validation</p>
