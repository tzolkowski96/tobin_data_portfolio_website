...
const SkillCard: React.FC<SkillCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-slate-800/50 backdrop-blur-sm rounded-xl shadow-sm hover:shadow-md transition-all p-6 border border-slate-100 dark:border-slate-700"
    >
